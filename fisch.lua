...
do
    ...
    local JayFreeze = Tabs.Main:AddToggle("JayMyFreeze", {
        Title = "Freeze Position",
        Description = "Freezes player position and rotation",
        Default = false
    })
    JayFreeze:OnChanged(function()
        JayFreeze = JayFreeze.Value
        if JayFreeze then
            JayFreezePosition()
        end
    end)
    ...
    Tabs.Main:AddButton({
        Title = "Go to Treasure Chest",
        Description = "You need the Fixed Map first!",
        Callback = function()
